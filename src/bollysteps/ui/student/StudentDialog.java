...
//JDialog that combines StudentInfoPanel with buttons 
//methods to layout design of this JDialog

public abstract class StudentDialog extends JDialog {
    ...
    protected abstract boolean saveStudent();
    
    protected abstract StudentInfoPanel createInfoPanel(UI ui);
